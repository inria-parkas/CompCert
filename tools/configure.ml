...
let coq_project_content = "-R _build/default/platform/lib compcert.lib -R _build/default/platform/common compcert.common -R _build/default/platform/backend compcert.backend -R _build/default/platform/cfrontend compcert.cfrontend -R _build/default/platform/driver compcert.driver -R _build/default/platform/cparser compcert.cparser -R _build/default/platform/export compcert.export -R _build/default/flocq Flocq -R _build/default/MenhirLib MenhirLib\n"
